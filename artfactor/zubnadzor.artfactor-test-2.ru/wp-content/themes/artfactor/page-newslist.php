...
<main class="main main--page" data-barba="container">
    ...
    <div class="container container_grid page" style="padding:0; margin-bottom:100px;grid-template-rows:1fr;grid-template-columns:1fr;margin-top:50px;" data-aos="fade-in" data-aos-duration="500" data-aos-easing="ease-in-sine">
